...
--
-- Host: localhost    Database: burnlab_db
-- ------------------------------------------------------
...
CREATE TABLE `cart` (
  ...
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`buyer_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
CREATE TABLE `orders` (
  ...
  `status` enum('placed','paid','fulfilled','refunded','canceled') DEFAULT 'placed',
...
CREATE TABLE `support_tickets` (
  ...
  KEY `about_order` (`about_order`),
  CONSTRAINT `support_tickets_ibfk_1` FOREIGN KEY (`opened_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  CONSTRAINT `support_tickets_ibfk_2` FOREIGN KEY (`about_order`) REFERENCES `orders` (`order_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-08  2:43:59
